...
const Contact = () => {
    ...
    return (
        <div className="px-[5%] max-w-screen-lg mx-auto my-10">
            <h1 className="text-center text-3xl sm:text-4xl lg:text-5xl font-bold my-10" data-aos="zoom-in">Contact us</h1>
            <form onSubmit={handleSubmit}> 
                <div className="flex flex-col md:flex-row justify-center items-center gap-5">
                    <label htmlFor="name" className="w-full text-lg font-medium"  data-aos="zoom-in">Name:
                        <input type="text" id="name" placeholder="Your name" className="input input-bordered w-full mt-2" required/>
                    </label>
                    <label htmlFor="subject" className="w-full text-lg font-medium"  data-aos="zoom-in">Service:
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-5">
                    <label htmlFor="email" className="w-full text-lg font-medium"  data-aos="zoom-in">Email:
                        <input type="email" id="email" placeholder="Email" className="input input-bordered w-full mt-2" required/>
                    </label>
                    <label htmlFor="number" className="w-full text-lg font-medium"  data-aos="zoom-in">Phone Number:
                ...
                <div className="flex justify-center items-center my-5" data-aos="zoom-in">
